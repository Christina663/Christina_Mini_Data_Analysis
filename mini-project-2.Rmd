...
*Graphing task 7 - Graph with alpha transparency*
We will group all the neighborhoods by the streets they are located on, and for each street we plot the mean heights of trees against each neighborhood on the street (i.e. y = mean height, x = neighborhood).
```{r}
